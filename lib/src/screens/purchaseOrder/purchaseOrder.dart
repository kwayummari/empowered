...
import 'package:empowered/src/gateway/purchaseOrderService.dart';
import 'package:empowered/src/provider/table2_notifier.dart';
import 'package:empowered/src/screens/purchaseOrder/topOfOrder.dart';
import 'package:empowered/src/utils/app_const.dart';
import 'package:empowered/src/widgets/app_button.dart';
import 'package:empowered/src/widgets/app_table2.dart';
  ...
  Future<void> saveData(purchaseId, supplierId) async {
    try {
      ...
      final purchaseOrderResponse = await purchaseOrderService
          .savePurchaseOrder(context, purchaseId, supplierId, '1');
    } catch (e) {
      setState(() {
        hasError = true;
        isLoading = false;
